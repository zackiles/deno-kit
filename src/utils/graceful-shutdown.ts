/**
 * Graceful shutdown handler that manages process signals and performs cleanup.
 * Implemented as a singleton to ensure only one instance controls the signal handlers.
 *
 * @module
 */
