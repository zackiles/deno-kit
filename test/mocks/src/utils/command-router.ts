/**
 * Mock CLI Command Router for testing
 *
 * This is a mock version of the command-router.ts file to avoid the issue with
 * spaces in the URL path when running tests.
 */
